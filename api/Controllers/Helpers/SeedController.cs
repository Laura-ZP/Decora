...
public class SeedController : BaseApiController
{
    ...
    public async Task<ActionResult> CreateDummyMembers()
    {
        ...
        if (databaseExists == true)
            ...
            await _client.DropDatabaseAsync("Decora");
        ...
        await _roleManager.CreateAsync(new AppRole { Name = "architecture" });
        await _roleManager.CreateAsync(new AppRole { Name = "client" });
        #endregion
